...
SELECT 
    ROUND(sysdate, 'year') -- 년 기준 반올림
FROM dual;

SELECT 
    ROUND(sysdate, 'month') -- 월 기준 반올롬
FROM dual;

SELECT 
     ROUND(sysdate, 'day') -- 주 기준으로 반올림(해당 주의 일요일날짜)
FROM dual;
...
SELECT 
    TRUNC(sysdate, 'year') -- 년 기준 절사
FROM dual;

SELECT 
    TRUNC(sysdate, 'month') -- 월 기준 절사
FROM dual;

SELECT 
     TRUNC(sysdate, 'day') -- 주 기준으로 절사(해당 주의 일요일날짜)
FROM dual;
