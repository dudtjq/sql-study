...
CREATE SEQUENCE dept2_seq 
    ...
    MINVALUE 1 -- 최소겂 (기본값은 증가일때 1, 감소일 때 -1028)
    NOCACHE -- 캐시 메모리 사용 여부(CACHE)
    NOCYCLE; -- 순환 여부 (NOCYCLE이 기본값, 순환시키려면 CYCLE )
...
SELECT dept2_seq.CURRVAL FROM dual; -- 현재 시퀀스값 확인
...
ALTER SEQUENCE dept2_seq INCREMENT BY -17;
